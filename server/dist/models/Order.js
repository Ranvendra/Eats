...
const orderItemSchema = new mongoose_1.Schema({
    menuItemId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: "MenuItem", required: true },
...
const orderSchema = new mongoose_1.Schema({
    ...
    restaurantId: { type: mongoose_1.default.Schema.Types.ObjectId, ref: "Restaurant", required: true, index: true },
